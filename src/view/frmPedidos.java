...
public class frmPedidos extends javax.swing.JInternalFrame {
    ...
    private static String TIPO = "P";

    /**
     * Creates new form frmPedidos1
     */
    public frmPedidos() {
        initComponents();
        try {
            ...
            txtDataEntrega.setFormatterFactory(ddfData);
            txtDataVenda.setFormatterFactory(ddfData);
            ...
            txtValorEntrada.setFormatterFactory(new DefaultFormatterFactory(formatter));
            //txtSubTotal.setFormatterFactory(dffPreco);
            //txtTotal.setFormatterFactory(dffPreco);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        painelCobranca = new javax.swing.JPanel();
        jLabel19 = new javax.swing.JLabel();
        txtValorEntrada = new javax.swing.JFormattedTextField();
        jLabel20 = new javax.swing.JLabel();
        spnQtdParcelas = new javax.swing.JSpinner();
        jScrollPane4 = new javax.swing.JScrollPane();
        tblParcelas = new javax.swing.JTable();
        btnGerarParcela = new javax.swing.JButton();
        btnCancelarParcela = new javax.swing.JButton();
        chAvista = new javax.swing.JCheckBox();
        ...
        btnEntregue.setText("Pedido Entregue");
            ...
            .addGroup(painelTabelaLayout.createSequentialGroup()
                ...
                .addGroup(painelTabelaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(painelTabelaLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnAbrirPedido, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(painelTabelaLayout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtDataEntrega, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(painelClienteLayout.createSequentialGroup()
                        ...
                        .addGroup(painelClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(painelClienteLayout.createSequentialGroup()
                                ...
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(painelClienteLayout.createSequentialGroup()
                                .addComponent(cmbCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 305, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        spnQtdParcelas.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(0), Integer.valueOf(0), null, Integer.valueOf(1)));
        ...
        tblParcelas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Parcela", "Num Duplicata", "Data Vcto", "Valor"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jScrollPane4.setViewportView(tblParcelas);

        btnGerarParcela.setText("Gerar");
        ...
        btnCancelarParcela.setText("Cancelar");
        btnCancelarParcela.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCancelarParcelaActionPerformed(evt);
            }
        });

        chAvista.setText("À Vista");

        jLabel22.setText("+");

        javax.swing.GroupLayout painelCobrancaLayout = new javax.swing.GroupLayout(painelCobranca);
        painelCobranca.setLayout(painelCobrancaLayout);
        painelCobrancaLayout.setHorizontalGroup(
            painelCobrancaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(painelCobrancaLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(painelCobrancaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel19)
                    .addComponent(txtValorEntrada, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(painelCobrancaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(painelCobrancaLayout.createSequentialGroup()
                        .addComponent(spnQtdParcelas, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(44, 44, 44)
                        .addComponent(chAvista)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btnGerarParcela, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        painelCobrancaLayout.setVerticalGroup(
            ...
            .addGroup(painelCobrancaLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(painelCobrancaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel19)
                    .addComponent(jLabel20))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(painelCobrancaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(spnQtdParcelas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnGerarParcela)
                    .addComponent(btnCancelarParcela)
                    .addComponent(chAvista)
                    .addComponent(jLabel22))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        tabBase.addTab("Cobrança", painelCobranca);
        ...
        painelPedidoLayout.setVerticalGroup(
            ...
            .addGroup(painelPedidoLayout.createSequentialGroup()
                ...
                .addGap(31, 31, 31)
                .addGroup(painelPedidoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tabBase, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(painelCliente, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        painelBaseLayout.setHorizontalGroup(
            ...
            .addGroup(painelBaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(painelPedido, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 945, Short.MAX_VALUE))
        );
        painelBaseLayout.setVerticalGroup(
            painelBaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(painelTabela, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addGroup(painelBaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(painelPedido, javax.swing.GroupLayout.DEFAULT_SIZE, 659, Short.MAX_VALUE))
        );
    ...
    private void carregaCamposEditar() {
        try {
            ...
            if (tblPedidos.getRowCount() > 0) {
                ...
                int poslinha = tblPedidos.getSelectedRow();
                dped.setPed_id((Integer) tblPedidos.getValueAt(poslinha, 0));
                dped.retornaDadosPedido();
                if (poslinha >= 0) {
                    txtId.setText(String.valueOf(dped.getPed_id()));
                    txtNumPed.setText(String.valueOf(dped.getPed_num()));
                    Date dataVenda = dped.getDt_venda();
                    Date dataEntrega = dped.getDt_Entrega();

                    txtDataVenda.setText(sdf.format(dataVenda));
                    txtDataEntrega.setText(sdf.format(dataEntrega));
                    ...
                    atualizaTabelaParcelas(ListaDup);
    ...
    private void atualizaTabelaParcelas(ArrayList<DaoDuplicata> daoDup) {
        limpaTable(tblParcelas);
        String linha[] = new String[]{"", "", "", ""};
        DefaultTableModel tbl = (DefaultTableModel) tblParcelas.getModel();
        try {
            int posicao = -1;
            for (DaoDuplicata dupPedido : daoDup) {
                posicao++;
                tbl.addRow(linha);
                tbl.setValueAt(dupPedido.getDup_numero(), posicao, 1);
                tbl.setValueAt(sdf.format(dupPedido.getDtVcto()), posicao, 2);
                tbl.setValueAt(nfPreco.valueToString(dupPedido.getDup_valor()), posicao, 3);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Ocorreu um erro:" + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void atualizaTabelaParcelasGerar() {
        StringBuilder sb = new StringBuilder(txtTotal.getText().replaceAll(",", "."));
        sb.delete(0, 3);
        int qtdParcelas = (Integer) spnQtdParcelas.getValue();
        double valor = Double.parseDouble(sb.toString());
        double valorEntrada;
        if (txtValorEntrada.getText().isEmpty()) {
            valorEntrada = 0;
        } else {
            valorEntrada = Double.parseDouble(txtValorEntrada.getText().replace(",", "."));
        }
        String dataVctoStr;
        Date dataVcto;
        if (chAvista.isSelected()) {
            dataVcto = new Date(System.currentTimeMillis());
            dataVctoStr = sdf.format(dataVcto);
            qtdParcelas = 1;
        } else {
            dataVctoStr = null;
        }
        double valorParcela = (valor - valorEntrada) / qtdParcelas;
        limpaTable(tblParcelas);
        String linha[] = new String[]{"", "", "", ""};
        DefaultTableModel tbl = (DefaultTableModel) tblParcelas.getModel();
        try {
            ...
            if (!txtValorEntrada.getText().isEmpty()) {
                posicao++;
                tbl.addRow(linha);
                tbl.setValueAt("E", posicao, 0);
                tbl.setValueAt(txtNumPed.getText() + "/E", posicao, 1);
                tbl.setValueAt(null, posicao, 2);
                tbl.setValueAt(nfPreco.valueToString(valorEntrada), posicao, 3);
            }
            for (int i = 0; i < qtdParcelas; i++) {
                posicao++;
                tbl.addRow(linha);
                tbl.setValueAt(String.valueOf(i + 1), posicao, 0);
                tbl.setValueAt(txtNumPed.getText() + "/" + String.valueOf(i + 1), posicao, 1);
                tbl.setValueAt(dataVctoStr, posicao, 2);
                tbl.setValueAt(nfPreco.valueToString(valorParcela), posicao, 3);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Ocorreu um erro:" + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void gravarparcelasBD() {
        int linhas = tblParcelas.getRowCount();
        if (linhas > 0) {
            DaoDuplicata ddup = new DaoDuplicata();
            try {
                for (int i = 0; i < linhas; i++) {
                    ddup.setDup_numero(String.valueOf(tblParcelas.getValueAt(i, 1)));
                    ddup.setDtEmissao(dataAtual);
                    ddup.setCli_id(listaCli.get(cmbCliente.getSelectedIndex()).getId_cli());
                    ddup.setDtVcto(sdf.parse((String) (tblParcelas.getValueAt(i, 2))));
                    ddup.setDtPagamento(new Date());
                    ddup.setPed_id(Integer.parseInt(txtId.getText()));
                    StringBuilder sb = new StringBuilder();
                    sb = new StringBuilder(tblParcelas.getValueAt(i, 3).toString().replaceAll(",", "."));
                    sb.delete(0, 3);
                    ddup.setDup_valor(Double.parseDouble(sb.toString()));
                    ddup.setDup_saldo(Double.parseDouble(sb.toString()));
                    ddup.incluir();
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Ocorreu um Erro no Banco de Dados" + e.getMessage(), "Erro:",
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        try {
            DaoPedidoOrcamento dped = new DaoPedidoOrcamento();
            int poslinha = tblPedidos.getSelectedRow();
            dped.setPed_id(Integer.parseInt((tblPedidos.getValueAt(poslinha, 0)).toString()));
        ...
        try {
            ...
            if (poslinha > -1) {
                ...
                if (verificaDup) {
                    ...
                    ditem.setPed_id((Integer) tblPedidos.getValueAt(poslinha, 0));
    ...
    private void btnEntregueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntregueActionPerformed
        ...
        if (poslinha > -1) {
            try {
                dped.atualizaStatus(1, (Integer) tblPedidos.getValueAt(poslinha, 0));
                formInternalFrameOpened(null);
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Ocorreu um Erro no Banco de Dados" + e.getMessage(), "Erro:",
                        JOptionPane.ERROR_MESSAGE);
    ...
    private void btnAbrirPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAbrirPedidoActionPerformed
        ...
        if (poslinha > -1) {
            try {
                dped.atualizaStatus(0, (Integer) tblPedidos.getValueAt(poslinha, 0));
                tblPedidos.setSelectionBackground(Color.white);
                tblPedidos.setSelectionForeground(Color.black);
                formInternalFrameOpened(null);
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Ocorreu um Erro no Banco de Dados" + e.getMessage(), "Erro:",
                        JOptionPane.ERROR_MESSAGE);
    ...
    private void btnCancelarPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarPedidoActionPerformed
        ...
        if (poslinha > -1) {
            try {
                dped.atualizaStatus(2, (Integer) tblPedidos.getValueAt(poslinha, 0));
                formInternalFrameOpened(null);
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Ocorreu um Erro no Banco de Dados" + e.getMessage(), "Erro:",
                        JOptionPane.ERROR_MESSAGE);
...
//        txtSubTotal.setFormatterFactory(dffQt);
    ...
    private void btnGerarParcelaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarParcelaActionPerformed
        if (tblParcelas.getRowCount() > 0) {
            int resposta = JOptionPane.showConfirmDialog(this, "Deseja realmente gerar novas parcelas?",
                    "Aviso", JOptionPane.YES_NO_OPTION);

            if (resposta == JOptionPane.YES_OPTION) {
                atualizaTabelaParcelasGerar();
                JOptionPane.showMessageDialog(null, "Parcelas Geradas com sucesso!\nInsira as datas de vencimento e salve!", "Info:",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        } else {
            atualizaTabelaParcelasGerar();
    ...
    private void btnCancelarParcelaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarParcelaActionPerformed
        try {
            DaoDuplicata ddup = new DaoDuplicata();
            ArrayList<DaoDuplicata> ListaDup;
            ListaDup = ddup.retornaItensPedido(Integer.parseInt(txtId.getText()));
    ...
    }//GEN-LAST:event_btnCancelarParcelaActionPerformed

    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
        try {
            DaoPedidoOrcamento dped = new DaoPedidoOrcamento();
            dped.setPed_id(Integer.parseInt(txtId.getText()));
            dped.setPed_tipo(TIPO);
            dped.setPed_num(Integer.parseInt(txtNumPed.getText()));
            Date dataVenda = sdf.parse(txtDataVenda.getText());
            Date dataEntrega = sdf.parse(txtDataEntrega.getText());
            dped.setDt_venda(dataVenda);
            dped.setDt_Entrega(dataEntrega);
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        try {
            ...
            par1 = "pedId";
            parametros.put(par1, tblPedidos.getValueAt(tblPedidos.getSelectedRow(), 0));
    ...
    private javax.swing.JButton btnCancelarParcela;
    ...
    private javax.swing.JCheckBox chAvista;
    ...
    private javax.swing.JPanel painelCobranca;
    ...
    private javax.swing.JSpinner spnQtdParcelas;
